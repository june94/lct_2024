...
THRESH = [0.3, 0.45, 0.4, 0.25, 0.25] # spec confiedence thresholds for each class (for video)

MAP_DANGER = {1: "ОПАСНОСТЬ",
              0: "Прочее",} # dict to map result danger_tags to namings for final display
...
IMAGE_SIZE_THRESH = 3840*2160 # min image size threshold to be predicted with sahi (default is 4k) 
